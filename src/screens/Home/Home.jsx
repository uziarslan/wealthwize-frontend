    ...
    <div className="bg-white w-full relative min-h-screen">
      ...
      <header id="home" className="relative w-full h-auto md:h-[550px] lg:h-[600px]">
        ...
        <div className="relative z-10 py-[50px] sm:py-[60px] md:py-[70px] lg:py-[80px] max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[60px]">
          ...
          <h1 className="w-full max-w-full md:max-w-[621px] [font-family:'Poppins',Helvetica] font-bold text-[#5ce0e5] text-[40px] sm:text-[48px] md:text-[56px] lg:text-[64px] xl:text-[72px] tracking-[-0.02em] leading-[1.2] sm:leading-[1.15] md:leading-[1.1] lg:leading-[1.1] text-left">
          ...
          <div className="mt-[32px] sm:mt-[40px] md:mt-[44px] lg:mt-[48px] w-full max-w-[600px] relative">
            ...
            />
              ...
              <Button 
                ...
                className="absolute top-[5px] right-[5px] w-[120px] sm:w-[140px] md:w-[170px] h-[60px] sm:h-[65px] md:h-[75px] rounded-[12px] sm:rounded-[14px] md:rounded-[18px] bg-[linear-gradient(90deg,rgba(90,225,230,1)_0%,rgba(43,79,238,1)_100%)] [font-family:'Poppins',Helvetica] font-semibold text-white text-[13px] sm:text-[15px] md:text-[17px] transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95"
              >
                Get Started
              </Button>
          </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <CardContent className="p-0">
                ...
                <h3 className="mt-[30px] md:mt-[40px] lg:mt-[49px] w-full flex items-center justify-center [font-family:'Poppins',Helvetica] font-bold text-[#091a24] text-[22px] md:text-[26px] lg:text-[28px] text-center tracking-[0] leading-[normal] px-[10px] transition-colors duration-300 group-hover:text-[#5ce0e5]">
                  {service.title}
                </h3>
                <p className="mt-[20px] md:mt-[26px] w-full flex items-center justify-center opacity-65 [font-family:'Poppins',Helvetica] font-normal text-[#696969] text-base md:text-lg text-center tracking-[0] leading-[1.5] whitespace-pre-line px-[20px] pb-[30px] transition-opacity duration-300 group-hover:opacity-80">
                  {service.description}
                </p>
              </CardContent>
            </Card>
      ...
      <section id="about" className="relative w-full mt-[80px] md:mt-[120px]">
        <div className="max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[60px]">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            <h2 className="w-full [font-family:'Poppins',Helvetica] font-bold text-[#091a24] text-[28px] md:text-[32px] lg:text-4xl tracking-[0] leading-[1.3] text-center lg:text-left">
              Trusted by over 3 million Canadians
            </h2>

            <p className="mt-[20px] md:mt-[23px] w-full [font-family:'Poppins',Helvetica] font-normal text-[#091a24] text-base md:text-lg tracking-[0] leading-[1.6] opacity-65 text-center lg:text-left">
            ...
            <div className="mt-[30px] md:mt-[40px] flex flex-col gap-[30px] md:gap-[35px]">
              {stats.map((stat, index) => (
                <div key={index} className="flex flex-col gap-[6px] text-center lg:text-left group cursor-pointer transition-transform duration-300 hover:translate-x-2">
                  <div className="[font-family:'Poppins',Helvetica] font-semibold text-[#5ce0e5] text-xl md:text-2xl tracking-[0] leading-[normal] transition-all duration-300 group-hover:scale-110 group-hover:text-[#2b4fee]">
                    {stat.value}
                  </div>
                  <div className="[font-family:'Poppins',Helvetica] font-normal text-black text-base md:text-lg tracking-[0] leading-[normal] transition-opacity duration-300 group-hover:opacity-80">
                    {stat.label}
                  </div>
                </div>
              ))}
      ...
      <section className="relative w-full mt-[80px] md:mt-[120px]">
        <div className="max-w-[1440px] mx-auto px-[20px] md:px-[40px] lg:px-[60px]">
          <h2 className="w-full text-center [font-family:'Poppins',Helvetica] font-bold text-[#091a24] text-[32px] md:text-[40px] lg:text-5xl tracking-[0] leading-[normal] mb-[30px] md:mb-[50px]">
        ...
        <div className="relative min-h-[200px] md:min-h-[250px]">
          <blockquote 
            ...
            className="max-w-[900px] mx-auto text-center [font-family:'Poppins',Helvetica] font-normal italic text-[#091a24] text-[18px] md:text-[24px] lg:text-[28px] tracking-[0] leading-[1.4] px-[20px] md:px-[40px] mb-[30px] md:mb-[40px] animate-fadeIn"
          >
          ...
          <div 
            ...
            className="text-center [font-family:'Poppins',Helvetica] font-semibold text-[#091a24] text-[22px] md:text-[26px] lg:text-[28px] tracking-[0] leading-[normal] mb-[10px] animate-fadeIn"
          >
          ...
          <div 
            ...
            className="text-center opacity-80 [font-family:'Poppins',Helvetica] font-medium text-[#091a24] text-base md:text-lg tracking-[0] leading-[normal] mb-[40px] md:mb-[50px] animate-fadeIn"
          >
            ...
            <button
              ...
              className={`transition-all ${
                currentTestimonial === index
                  ? "w-[15px] h-[15px] bg-[#5ce0e5] rounded-[7.5px]"
                  : "w-2.5 h-2.5 mt-[3px] bg-[#c4c4c4] rounded-[5px] hover:bg-[#5ce0e5] hover:opacity-50"
              }`}
